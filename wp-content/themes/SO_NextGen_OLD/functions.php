...
function seniorsoutdoors_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'seniorsoutdoors' ),
	) );
 ...
 */
function seniorsoutdoors_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'seniorsoutdoors_content_width', 640 );
}
add_action( 'after_setup_theme', 'seniorsoutdoors_content_width', 0 );
...
function seniorsoutdoors_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'seniorsoutdoors' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'seniorsoutdoors' ),
...
function seniorsoutdoors_scripts() {
	...
	wp_enqueue_script( 'seniorsoutdoors-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'seniorsoutdoors-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
